...
let Kitty = document.getElementById("touch-me-img");
...
playBTN.addEventListener("click", function () {
    ...
    document.body.style.backgroundImage = "url('kitttty.png')";
  });
...
/*
  let total = 0;
function myTimer() {
  document.getElementById("face").src = "k.png";
  if (total === 100 ) {
    document.getElementById("face").src = "pixil-frame-0.png";
  }
}
*/
...
myImage.onclick = function() {
    ...
    if(mySrc === 'k.png') {
      myImage.setAttribute('src','pixil-frame-0.png');
    } else {
      myImage.setAttribute('src','pixil-frame-0.png');
    }
    money += moneyup;
